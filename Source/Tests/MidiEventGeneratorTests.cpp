...
public:
    ...
    void runTest() override
    {
        beginTest ("Case 1: Debounce & Attack");
        {
            ...
            generator.processBlock(-100.0f, -30.0f, false, 0.0f, 0.0f, 2, 0, 0, 0.0f, 0.0f, 1, 128, midiMessages);
            ...
            generator.processBlock(-10.0f, -30.0f, false, 440.0f, 0.5f, 2, 0, 0, 0.0f, 0.0f, 1, 128, midiMessages);
            expect (midiMessages.isEmpty());
            expect (generator.getCurrentlyPlayingNote() == -1);
        ...
        beginTest ("Case 2: Pitch Bend Legato vs Glide");
        {
            ...
            generator.processBlock(-10.0f, -30.0f, false, microtonalFreq, 0.5f, 2, 0, 0, 0.0f, 0.0f, 1, 128, midiMessages);
            ...
            generator.processBlock(-10.0f, -30.0f, false, legatoFreq, 0.5f, 2, 0, 0, 0.0f, 0.0f, 1, 128, midiMessages);
